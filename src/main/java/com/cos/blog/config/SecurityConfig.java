...
@EnableWebSecurity //필터를 추가 = 스프링 시큐리티가 활성화가 되어 있는데 어떤 설정을 해당 파일에서 하겠다.
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	@Bean //IoC가 된다. 리턴하는 BCryptPasswordEncoder 를 스프링이 관리해서 필요할때 가져와서 사용하면 된다.
	...
	http
		...
		.and()
			...
			.defaultSuccessUrl("/"); //정상적으로 요청이 완료되면 /로 이동된다.
	}
